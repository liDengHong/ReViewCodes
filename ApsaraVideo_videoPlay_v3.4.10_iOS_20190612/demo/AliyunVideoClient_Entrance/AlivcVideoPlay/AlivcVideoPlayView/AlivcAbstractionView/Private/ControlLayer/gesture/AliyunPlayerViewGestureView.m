...
- (instancetype)initWithFrame:(CGRect)frame {
    ...
    if (self) {
        ...
        self.brightImageView.image = [AliyunUtil imageWithNameInBundle:@"al_video_brightness_bg" skin:AliyunVodPlayerViewSkinBlue];
...
- (void)setEnableSingleClickGesture:(BOOL)enableGesture {
    [self.gestureModel setSingleClickEnableGesture:enableGesture];
}

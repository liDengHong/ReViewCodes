...
- (void)setModel:(AlivcVideoPlayListModel *)model{
    ...
    self.durationLabel.text = [AliyunUtil timeformatFromSeconds:model.duration ];
    
    [self.leftImageView sd_setImageWithURL:[NSURL URLWithString:model.coverURL]];
    
//    NSString *imgURL = model.coverURL;
//    UIImage *cachedImage = [[SDImageCache sharedImageCache] imageFromDiskCacheForKey:imgURL];
//    if ( !cachedImage ) {
//        [self downloadImage:model.coverURL];
//    } else {
//        self.leftImageView.image = cachedImage;
//    }
}
